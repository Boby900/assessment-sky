...
import { Cloud, Code, Cpu, Database, Globe, Server, Shield, LucideIcon } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-[#020817] overflow-x-hidden">
      ...
      <main className="container mx-auto px-4 py-20 text-center relative">
        <p className="text-lg text-gray-300 mb-4">Secure. Scalable. Always Reliable</p>
        ...
        <div className="relative w-full max-w-[90vw] aspect-square mx-auto mb-12" style={{ maxWidth: "600px" }}>
          {/* Center Icon */}
